...
export default function Hero() {
  ...
  return (
    <section id="home" className="section-base hero-section min-h-screen flex flex-col justify-center pt-36 md:pt-40 pb-16">
      <div className="container">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-6" data-aos="fade-up">
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold tracking-tight leading-tight">
              <span className="text-text-dark dark:text-text-light">Adam </span>
              <span className="text-primary">Fitriyono</span>
            </h1>

            <TypewriterRole />

            <p className="text-muted leading-relaxed max-w-lg">
              Focused on creating beautiful, responsive, and interactive user interfaces. I bring designs to life with clean, efficient code.
            </p>
          ...
          <div data-aos="fade-up" data-aos-delay="150">
            <div className="photo-frame aspect-[4/5] md:aspect-square">
        ...
        <div className="flex justify-center mt-16 md:mt-20" data-aos="fade-up" data-aos-delay="200">
          <a
            ...
            className="w-11 h-11 btn-icon hero-scroll-btn"
